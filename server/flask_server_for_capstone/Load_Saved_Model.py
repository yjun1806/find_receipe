...
path = '/home/kunde/Capstone_Project/cnnmodel/densenet161-transfer_bts128_ep100_20190823145719.pth'
inference_type = 'gpu'
...
def predict(filepath):
    ...
    predict_img_path = filepath
    total_inference_time, result, classes = train_util.img_prediction(predict_img_path, model, topk=3, gt='none', inference_type=inference_type)
